...
//                        //console.log(deferred);
        ...
        .controller('createPreAuthorizationRequestCtrl', ['$scope', '$http','createUpdateDto','getQueryParameter','$window','documentList','stepsSaved','$upload','preAuthorizationId','clientId',
