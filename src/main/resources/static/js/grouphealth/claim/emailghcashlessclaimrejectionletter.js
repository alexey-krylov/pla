...
function sendEmail() {
    ...
    var groupHealthCashlessClaimId=$('#groupHealthCashlessClaimId').val();
    ...
    $.ajax({
        url: '/pla/grouphealth/claim/cashless/claim/underwriter/getgrouphealthcashlessclaimrejectionletter',
        type: 'POST',
        data: JSON.stringify({
            recipientMailAddress: toAddress, subject: subject, mailContent:mailContent,
            groupHealthCashlessClaimId:groupHealthCashlessClaimId, policyNumber:policyNumber
        }),
