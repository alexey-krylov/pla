(function (angular) {
    "use strict";
    var app= angular.module('CashLessClaimUpload', ['common', 'ngRoute', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.alert', 'mgcrea.ngStrap.popover',
    ...
    app.config(['datepickerPopupConfig', function (datepickerPopupConfig) {
        ...
        .config(["$routeProvider", function ($routeProvider) {
            $routeProvider.when('/', {
                templateUrl: 'ghcashlessclaimupload.html',
                controller: 'CashLessClaimUploadController',
                resolve: {
    ...
    app.controller('CashLessClaimUploadController', ['$scope', '$http','$upload','hcps' , function ($scope, $http, $upload, hcps) {
...
//        console.log($scope.uploadPreAuthorizationDto.batchDate);
        ...
        $scope.$watchCollection('[uploadPreAuthorizationDto.hcpCode, showDownload]', function (n) {
            ...
            if (n[1]) {
                $scope.dropdown = [{
                    ...
                    "href": "/pla/grouphealth/claim/cashless/claim/downloadghcashlessclaimtemplate/" + $scope.qId
                }
                ];
            } else {
                $scope.dropdown = [{
                    "text": "<a><img src=\"/pla/images/xls-icon.png\">download</a>",
                    "href": "/pla/grouphealth/claim/cashless/claim/downloadghcashlessclaimtemplate/" + $scope.uploadPreAuthorizationDto.hcpCode
                },{
                    "text": "<a><img src=\"/pla/images/xls-icon.png\">Error File</a>",
                    "href": "/pla/grouphealth/claim/cashless/claim/downloaderrorpreauthtemplate/" + $scope.qId
                }
                ];
            }
        });
        ...
        $scope.uploadPreAuthorizationTemplate = function () {
            ...
            $upload.upload({
                url: '/pla/grouphealth/claim/cashless/claim/uploadghcashlessclaimtemplate',
