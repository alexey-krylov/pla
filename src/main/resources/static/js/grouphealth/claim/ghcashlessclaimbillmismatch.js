...
var  app = angular.module('CashLessClaimBill', ['common', 'ngRoute','ngMessages', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.alert', 'mgcrea.ngStrap.popover',
    ...
    .config(["$routeProvider", function ($routeProvider) {
        $routeProvider.when('/', {
                templateUrl: 'ghcashlessclaimbillmismatch.html',
                controller: 'CashLessClaimBillCtrl',
                resolve:{
...
//cancel button
            ...
            $scope.back = function () {
                ...
                window.location.href = '/pla/grouphealth/claim/cashless/claim/getallbillmismatchedgrouphealthcashlessclaims';
            };
            ...
            $scope.approveGHCashlessClaim = function () {
                ...
                $.when($scope.constructCommentDetails()).done(function () {
                    $http({
                        url: '/pla/grouphealth/claim/cashless/claim/billmismatch/approve',
                        method: 'POST',
                        data: $scope.createUpdateDto
