...
var searchPreAuthorizationModule = (function(){
    ...
    PreAuthorizationServices.updatePreAuthorization = function () {
        ...
        window.location.href = "/pla/grouphealth/claim/cashless/claim/updateviewbillmismatch?groupHealthCashlessClaimId=" + groupHealthCashlessClaimId +"&clientId="+ clientId +"&mode=edit";
    };
    ...
    PreAuthorizationServices.viewPreAuthorization =  function(){//activate deactive when click radio button
                ...
                window.location.href = "/pla/grouphealth/claim/cashless/updateviewbillmismatch?groupHealthCashlessClaimId=" + groupHealthCashlessClaimId +"&clientId="+ clientId+"&mode=view";
