...
function sendEmail() {
    ...
    var preAuthorizationId=$('#preAuthorizationId').val();
    ...
    $.ajax({
        url: '/pla/grouphealth/claim/cashless/preauthorizationrequest/underwriter/emailpreauthorizationrequirementletter',
        type: 'POST',
        data: JSON.stringify({
