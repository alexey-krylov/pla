(function (angular) {
        ...
        .config(["$routeProvider", function ($routeProvider) {
            ...
            $routeProvider.when('/', {
                    ...
                    resolve: {
                        ...
                        paypointStatus: ['$q', '$http', function ($q, $http) {
                            var deferred = $q.defer();
                            $http.get('/pla/core/paypoint/getallpaypointstatus').success(function (response, status, headers, config) {
                                deferred.resolve(response)
                            }).error(function (response, status, headers, config) {
                                deferred.reject();
                            });
                        ...
                        paypointgrades: ['$q', '$http', function ($q, $http) {
                            var deferred = $q.defer();
    ...
    app.controller('createPayPointCtrl', ['$scope','getQueryParameter','$http','$timeout', 'provinces', 'paypointStatus', 'paypointgrades', 'bankDetails', function ($scope,getQueryParameter,$http,$timeout, provinces, paypointStatus, paypointgrades, bankDetails) {
        ...
        $scope.paypointStatusResponse = paypointStatus;
        $scope.paypointGradeResponse = paypointgrades;
