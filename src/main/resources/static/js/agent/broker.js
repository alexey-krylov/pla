angular.module('brokerModule', ['common', 'ngRoute', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.alert', 'commonServices'])
    .controller('brokerController', ['$scope', '$http', 'channelType', 'authorisedToSell', 'teamDetails', 'provinces', '$timeout', '$alert', '$route', '$window', 'transformJson', 'getQueryParameter', 'agentDetails', 'globalConstants', 'nextAgentSequence', 'getProvinceAndCityDetail',
