...
App.controller('AssignTeamController',['$scope','$http','$window','$location','$alert',function($scope,$http,$window,$location,$alert){
     ...
     $http.get('http://5.9.249.195:6443/pla/core/team/getteamleaders').success(function(data){
                 //  console.log(data);
     ...
     /* $scope.teamLeaders=[{'teamLeaderId':'100','firstName':'sara','lastName':'ali'},
      ...
      $scope.url = window.location.search.split('=')[1];
       $http.get('http://5.9.249.195:6443/pla/core/team/openAssignPage?teamId='+$scope.url).success(function(data){
                  // console.log(data);
     ...
     $scope.getNewFromDate = function(fromDate) {
      ...
      $scope.submitAssignTeam = function(){
         ...
         $http.post('http://5.9.249.195:6443/pla/core/team/assign', $scope.assignTeam).success(function(data){
