angular.module('nonfuneralproudct', ['common', 'ngRoute', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.alert', 'mgcrea.ngStrap.popover', 'directives',
...
.config(['datepickerPopupConfig', function (datepickerPopupConfig) {
    ...
    .controller('NonFuneralProudctController', ['$scope', '$http', '$timeout', '$upload', 'provinces', 'getProvinceAndCityDetail', 'globalConstants',
...
$scope.planDetail={};
  ...
  console.log("asdsadsadsa"+ proposalNumber);
    ...
    .config(["$routeProvider", function ($routeProvider) {
        ...
        var queryParam = null;
        $routeProvider.when('/', {
            templateUrl: 'nonFuneralProudct.html',
            controller:'NonFuneralProudctController',
            resolve: {
