angular.module('funeralproudctClaim', ['common', 'ngRoute', 'mgcrea.ngStrap.select', 'mgcrea.ngStrap.alert', 'mgcrea.ngStrap.popover', 'directives',
...
.config(['datepickerPopupConfig', function (datepickerPopupConfig) {
    ...
    .controller('FuneralproudctClaimController', ['$scope', '$http', '$timeout', '$upload', 'provinces', 'getProvinceAndCityDetail', 'globalConstants',
...
//           $scope.saveclaimantDetail = function () {
//                    var requestclaimDetails= {  "claimintDetails":$scope.ClaimantDetails};
//
//                    console.log("claimDetails"+JSON.stringify(requestclaimDetails));
//              }
...
//alert("not");
 ...
 if($scope.policyId){
    $http.get('/pla/grouplife/claim/getrelationshipandcategory/'+$scope.policyId)
           .success(function(response,status,headers,config){
                          $scope.claimDetailsResponse=response;
                          })
...
//         alert("Bank bankCode :"+JSON.stringify( $scope.claimDetailsResponse));
 ...
 $scope.showAsssuredSearchModal=function(){
 console.log('ShowMethodRequest'+JSON.stringify($scope.claimDetails));

 $http.post('/pla/grouplife/claim/assuredsearch',$scope.claimDetails)
    .success(function(response,status,headers,config){
      $scope.assuredResponse=response;
//      alert("assured data response :"+JSON.stringify(response));
       console.log("assured search data send succesfully")
      })
    .error(function(response,status,headers,config){
      })
...
/*bank details*/
               ...
               $scope.getTheItemSelected = function (ele) {
                              ...
                              viewAssuredSearch.getTheItemSelected(ele);
                          };

// services.createUpdateclaim = function () {
//        alert("createUpdateProposal");
//       var policyId = this.selectedItem;
//      window.location.href = "edit?quotationId=" + policyId + "&mode=update";
//    };
...
$scope.planDetail={};
            $scope.saveClaimDetails=function()
            {
                    var request={
                    "claimDetails":$scope.claimDetails,
                    "ClaimantDetails":$scope.ClaimantDetails,
                    "planDetail":$scope.planDetail,
                    "bankDetails":$scope.bankDetails};
                    console.log("saveClaimDetails"+JSON.stringify(request));
  ...
  console.log("asdsadsadsa"+ proposalNumber);
    ...
    .config(["$routeProvider", function ($routeProvider) {
        ...
        var queryParam = null;
        $routeProvider.when('/', {
            templateUrl: 'funeralProudct.html',
            controller:'FuneralproudctClaimController',
            resolve: {
         ...
         var viewAssuredSearch = (function () {
             var services = {};
