...
public enum EndorsementStatus {
    ...
    PAYMENT_PENDING("Pending Endorsement Payment"), PAYMENT_RECEIVED("Accepted"), REFUND_PENDING("Accepted"), REFUND_PROCESSED("Accepted"), HOLD("Pending Endorsement Decision");
