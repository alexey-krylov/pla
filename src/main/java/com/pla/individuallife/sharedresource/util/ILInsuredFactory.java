...
public class ILInsuredFactory {
    ...
    @Autowired
    public ILInsuredFactory(IPremiumCalculator premiumCalculator, IProcessInfoAdapter processInfoAdapter, IGeneralInformationProvider generalInformationProvider, GLFinder glFinder) {
