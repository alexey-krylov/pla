...
public class InsuredBuilder {
    ...
    InsuredBuilder(PlanId insuredPlan, String planCode, BigDecimal premiumAmount, BigDecimal sumAssured, BigDecimal incomeMultiplier,List<ComputedPremiumDto> computedPremiumDtos) {
    ...
    public InsuredBuilder withCoveragePremiumDetail(String coverageName, String coverageCode, String coverageId, BigDecimal premium, BigDecimal sumAssured,List<ComputedPremiumDto> computedPremiumDtos) {
