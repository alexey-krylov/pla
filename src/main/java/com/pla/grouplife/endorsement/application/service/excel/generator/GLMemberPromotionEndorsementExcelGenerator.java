...
public class GLMemberPromotionEndorsementExcelGenerator extends AbstractGLEndorsementExcelGenerator {
    ...
    public HSSFWorkbook generate(PolicyId policyId,EndorsementId endorsementId) throws IOException {
        ...
        constraintCellDataMap.put(excelHeaderInString.indexOf("Old Category"), OccupationCategory.getAllCategory());
        constraintCellDataMap.put(excelHeaderInString.indexOf("New Category"), OccupationCategory.getAllCategory());
    ...
    public List<InsuredDto> getInsuredTemplateExcel(String endorsementId) throws IOException {
        ...
        List<Insured> insureds = Lists.newArrayList(glEndorsement.getPremiumEndorsement().getInsureds());
        List<InsuredDto> insuredDtoList = isNotEmpty(insureds) ? insureds.stream().map(new Function<Insured, InsuredDto>() {
            ...
            public InsuredDto apply(Insured insured) {
                ...
                insuredDto.setFamilyId(insured.getFamilyId()!=null?insured.getFamilyId().getFamilyId():"");
