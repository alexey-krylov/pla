...
@Component
public class GLMemberDeletionEndorsementExcelGenerator extends AbstractGLEndorsementExcelGenerator {
    ...
    public List<InsuredDto> getInsuredTemplateExcel(String endorsementId) throws IOException {
        ...
        List<Insured> insureds = Lists.newArrayList(glEndorsement.getMemberDeletionEndorsements().getInsureds());
