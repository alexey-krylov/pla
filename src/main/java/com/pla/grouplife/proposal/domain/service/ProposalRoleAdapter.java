 ...
 */
@Component
public class ProposalRoleAdapter {
    ...
    public GLProposalProcessor userToProposalProcessor(UserDetails userDetails) {
        ...
        if (!haspProposalProcessorRole) {
            throw new AuthorizationServiceException("User does not have Quotation processor(ROLE_GROUP_LIFE_PROPOSAL_PROCESSOR) authority");
        }
