 ...
 */
@Component
public class GlProposalCommandHandler {
    ...
    @Autowired
    public GlProposalCommandHandler(Repository<GroupLifeQuotation> glQuotationMongoRepository, GroupLifeQuotationService groupLifeQuotationService, IPremiumCalculator premiumCalculator, GLQuotationFinder glQuotationFinder, GlQuotationRepository glQuotationRepository) {
    ...
    @CommandHandler
    public String createQuotation(CreateGLProposalCommand createGLQuotationCommand) {
    ...
    @CommandHandler
    public String updateWithProposer(UpdateGLProposalWithProposerCommand updateGLQuotationWithProposerCommand) {
    ...
    @CommandHandler
    public String updateWithAgentDetail(UpdateGLProposalWithAgentCommand updateGLQuotationWithAgentCommand) {
    ...
    @CommandHandler
    public String generateQuotation(GenerateGLProposalCommand generateGLQuotationCommand) {
    ...
    @CommandHandler
    public String updateWithInsureDetail(UpdateGLProposalWithInsuredCommand updateGLQuotationWithInsuredCommand) {
        ...
        Set<Insured> insureds = insuredDtos.stream().map(new Function<InsuredDto, Insured>() {
            ...
            public Insured apply(InsuredDto insuredDto) {
                ...
                insuredDto.getCoveragePremiumDetails().forEach(coveragePremiumDetail -> {
                    BigDecimal coverageBasicPremium = computePlanBasicAnnualPremium(premiumDetail.getPlanId(), coveragePremiumDetail.getSumAssured().toPlainString(), String.valueOf(getAgeOnNextBirthDate(insuredDto.getDateOfBirth())), null, insuredDto.getGender().name(), 365, coveragePremiumDetail.getCoverageId());
    ...
    @CommandHandler
    public String updateWithPremiumDetail(UpdateGLProposalWithPremiumDetailCommand updateGLQuotationWithPremiumDetailCommand) {
    ...
    private GroupLifeQuotation populateAnnualBasicPremiumOfInsured(GroupLifeQuotation groupLifeQuotation, UserDetails userDetails, PremiumDetailDto premiumDetailDto) {
        if (premiumDetailDto.getPolicyTermValue() != 365) {
            ...
            for (Insured insured : insureds) {
                ...
                BigDecimal insuredPlanProratePremium = computeBasicProratePremium(planPremiumDetail.getPlanId().getPlanId(), planPremiumDetail.getSumAssured().toPlainString(), getAgeOnNextBirthDate(insured.getDateOfBirth()).toString(), occupationClass, insured.getGender().name(), premiumDetailDto.getPolicyTermValue(), null);
        ...
        Set<InsuredDependent> insuredDependents = insuredDependentDtos.stream().map(new Function<InsuredDto.InsuredDependentDto, InsuredDependent>() {
            ...
            public InsuredDependent apply(InsuredDto.InsuredDependentDto insuredDependentDto) {
                ...
                insuredDependentDto.getCoveragePremiumDetails().forEach(coveragePremiumDetail -> {
                    BigDecimal coverageBasicPremium = computePlanBasicAnnualPremium(premiumDetail.getPlanId(), coveragePremiumDetail.getSumAssured().toPlainString(), String.valueOf(getAgeOnNextBirthDate(insuredDependentDto.getDateOfBirth())), null, insuredDependentDto.getGender().name(), 365, coveragePremiumDetail.getCoverageId());
    ...
    @CommandHandler
    public void purgeGLQuotation(PurgeGLProposalCommand purgeGLQuotationCommand) {
    ...
    @CommandHandler
    public void closureGLQuotation(ClosureGLProposalCommand closureGLQuotationCommand) {
